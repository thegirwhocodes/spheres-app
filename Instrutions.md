...
8. add a reset button like the update and signed in buttons that
9. Come up with a full list of all the plug ins regular working professionals may want to connect their spheres to - all the intergations notion has, how they use it, and let there be somewhere the user can click to enable integartin for their speciic thing (like some project specific )
10. maybe a pulsing light aaround the the text scanning your mac or the search iconso the user knows things are still working even when scanning some
11. Can you write out the plan and put it in the plans folder
12. Tone of AI - let it be LLM style - forget about the costs
13. What does 22% eneergu in the side bar of suggested time blocks mean
14. Redo settings to let it be like nice and clean - like UI consistent, the smart, nice subtle, liquid glass UI for the user, not shouting like it it now
15. Resurfacing today - when clicked should lead straight to the page of the sphere
16. Can mind show previous chats with the AI - so perissitent memory
17. Week View in Smart Scheduller (Buttomns - Day, Weeek, Month)
18. the window for the date covers some of the numbers
19. no x button for when click schedul steeings
20. right click to delete a sphere
21. Remove page sliding - let the click just open a page like a regualr app or web app
    Set up writing system with exmaple for user.
    e.g.  proirotu no. call the dentist
22. Persistent spheres window at the top bar, when click user can quickly type in what they wanted as before (- they can just click the sphere it belongs to and type the line in and press enter- the typing system) and the AI processes it | Add this info into the onboardng
